...
Añade Recursos en un desplegable en el formulario.
...
Por defecto, es el titulo del Recurso lo que se muestra.
...
Permite filtrar la lista de los recursos en función de un campo de este mismo formulario.
